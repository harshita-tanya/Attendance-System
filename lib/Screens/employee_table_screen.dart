...
class _EmployeeTableState extends State<EmployeeTable> {
  ...
  late List<Map<String, dynamic>> uniqueList = [];
  late List<Map<String, dynamic>> queryList = [];
  ...
  @override
  void initState() {
    sessionList = List.from(widget.userData!['sessions']);
                    ...
                    child: DataTable(
                        ...
                        rows: selectedMonth == null
                            ? uniqueList.map((session) {
                                String sessionTime = (filterData(
                                            DateTime.parse(session['date'])) /
                                        60)
                                    .toStringAsFixed(2);
                                return DataRow(
                                    color: switchValue &&
                                            (double.parse(sessionTime) <= 480)
